...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./jquery.bxslider.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./jquery.bxslider.min.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_blazy__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_blazy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_blazy__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bxslider_dist_jquery_bxslider__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bxslider_dist_jquery_bxslider___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_bxslider_dist_jquery_bxslider__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bxslider_dist_jquery_bxslider_min_css__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bxslider_dist_jquery_bxslider_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_bxslider_dist_jquery_bxslider_min_css__);
/*
...
function runrunrun() {
	...
	let lazyTitles = new __WEBPACK_IMPORTED_MODULE_1_blazy___default.a({
	...
	let lazyScrollers = new __WEBPACK_IMPORTED_MODULE_1_blazy___default.a({
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.bxslider').bxSlider({
		//mode: 'vertical',
		pager: false,
		preloadImages: 'all',
		captions: true,
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()('nav a, .arrow a').click(function (e) {
		e.preventDefault();
		//console.debug(e, $(e.target).attr("href"), $("" + $(e.target).attr("href")))

		const section = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("href");
		const offset = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("" + section).offset().top;
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()(".archive").click(function (e) {
		const $wrapper = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
	...
	// let page = 1
	let $el = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("main");
	let $win = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window);
...
// module
exports.push([module.i, ".bx-wrapper{position:relative;margin-bottom:60px;padding:0;-ms-touch-action:pan-y;touch-action:pan-y;-moz-box-shadow:0 0 5px #ccc;-webkit-box-shadow:0 0 5px #ccc;box-shadow:0 0 5px #ccc;border:5px solid #fff;background:#fff}.bx-wrapper img{max-width:100%;display:block}.bxslider{margin:0;padding:0}ul.bxslider{list-style:none}.bx-viewport{-webkit-transform:translatez(0)}.bx-wrapper .bx-controls-auto,.bx-wrapper .bx-pager{position:absolute;bottom:-30px;width:100%}.bx-wrapper .bx-loading{min-height:50px;background:url(" + __webpack_require__(9) + ") center center no-repeat #fff;height:100%;width:100%;position:absolute;top:0;left:0;z-index:2000}.bx-wrapper .bx-pager{text-align:center;font-size:.85em;font-family:Arial;font-weight:700;color:#666;padding-top:20px}.bx-wrapper .bx-pager.bx-default-pager a{background:#666;text-indent:-9999px;display:block;width:10px;height:10px;margin:0 5px;outline:0;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px}.bx-wrapper .bx-pager.bx-default-pager a.active,.bx-wrapper .bx-pager.bx-default-pager a:focus,.bx-wrapper .bx-pager.bx-default-pager a:hover{background:#000}.bx-wrapper .bx-controls-auto .bx-controls-auto-item,.bx-wrapper .bx-pager-item{display:inline-block}.bx-wrapper .bx-pager-item{font-size:0;line-height:0}.bx-wrapper .bx-prev{left:10px;background:url(" + __webpack_require__(0) + ") 0 -32px no-repeat}.bx-wrapper .bx-prev:focus,.bx-wrapper .bx-prev:hover{background-position:0 0}.bx-wrapper .bx-next{right:10px;background:url(" + __webpack_require__(0) + ") -43px -32px no-repeat}.bx-wrapper .bx-next:focus,.bx-wrapper .bx-next:hover{background-position:-43px 0}.bx-wrapper .bx-controls-direction a{position:absolute;top:50%;margin-top:-16px;outline:0;width:32px;height:32px;text-indent:-9999px;z-index:9999}.bx-wrapper .bx-controls-direction a.disabled{display:none}.bx-wrapper .bx-controls-auto{text-align:center}.bx-wrapper .bx-controls-auto .bx-start{display:block;text-indent:-9999px;width:10px;height:11px;outline:0;background:url(" + __webpack_require__(0) + ") -86px -11px no-repeat;margin:0 3px}.bx-wrapper .bx-controls-auto .bx-start.active,.bx-wrapper .bx-controls-auto .bx-start:focus,.bx-wrapper .bx-controls-auto .bx-start:hover{background-position:-86px 0}.bx-wrapper .bx-controls-auto .bx-stop{display:block;text-indent:-9999px;width:9px;height:11px;outline:0;background:url(" + __webpack_require__(0) + ") -86px -44px no-repeat;margin:0 3px}.bx-wrapper .bx-controls-auto .bx-stop.active,.bx-wrapper .bx-controls-auto .bx-stop:focus,.bx-wrapper .bx-controls-auto .bx-stop:hover{background-position:-86px -33px}.bx-wrapper .bx-controls.bx-has-controls-auto.bx-has-pager .bx-pager{text-align:left;width:80%}.bx-wrapper .bx-controls.bx-has-controls-auto.bx-has-pager .bx-controls-auto{right:0;width:35px}.bx-wrapper .bx-caption{position:absolute;bottom:0;left:0;background:#666;background:rgba(80,80,80,.75);width:100%}.bx-wrapper .bx-caption span{color:#fff;font-family:Arial;display:block;font-size:.85em;padding:10px}", ""]);
